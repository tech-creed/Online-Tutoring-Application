                                        ...
                                        <div class="tab-pane fade show active" id="activeRoomsContent" role="tabpanel" aria-labelledby="activeRoomsTab">
                                            <div class="tutor-dashboard-setting-profile tutor-dashboard-content-inner">
                                                <div id="tutor_profile_cover_photo_editor">
                                                    ...
                                                    <div id="tutor_profile_area" data-fallback="../../../assets/img/instructor-img.jpeg" style="background-image:url(../../../assets/img/instructor-img.jpeg)">
        ...
        <div id="tutor-dashboard-footer-mobile">
            <div class="tutor-container">
                <div class="tutor-row">
                    ...
                    <a class="tutor-col-3 active" href="../settings/">
