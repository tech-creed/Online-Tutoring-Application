...
<body>
    ...
    <div class="tutor-wrap tutor-wrap-parent tutor-dashboard tutor-frontend-dashboard tutor-dashboard-student tutor-pb-80 container mt-5">
        ...
        <br>
        <!-- Room Creation Form -->
        <form action="../../../controllers/instructor/roomCreation.php" method="post">
            <div class="row">
                ...
                <div class="form-group col-8">
                    ...
                    <select class="form-control" id="studentId" name="studentId" required>
                        ...
                        <?php
                        $query = "SELECT user_id, first_name, last_name FROM users WHERE role = 'Student' AND user_id NOT IN (SELECT student_id FROM rooms WHERE is_closed = 0)";
            ...
            <button style="text-align: center;" type="submit" class="btn col-12">Create Room</button>
            </div>
        </form>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function addStudent(studentId, studentName) {
                ...
                var badge = '<span class="badge badge-primary mr-2" data-student-id="' + studentId + '">' + studentName + '   ' +
